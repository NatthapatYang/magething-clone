...
def bar_chart_score():  
    ...
    get_f_percent = percentage(f_data, max(f_data))
    get_m_percent = percentage(m_data, max(m_data))

    r_percent = list(zip(r_data, get_r_percent))
    f_percent = list(zip(f_data, get_f_percent))
    m_percent = list(zip(m_data, get_m_percent))
